...
the [GenServer](https://hexdocs.pm/elixir/GenServer.html) behavior. This has some powerful implications!

In this post I'm going to explain how to set this up and try some experiments.
...
docker build -t wasm_actor .
docker run -it wasm_actor bash
```
...
With that in mind, I implemented this barebones GenServer in `lib/wasm_actor.ex`:
