...
| ------------------ | ---- | -- | ------- | -------------- | - | --- | ---------- |
| `I32`✝ | `i32`, `isize`, `u32`, `usize` | `int32`, `uint32`, `int` | `Int32`, `Word32` | `i32`, `isize`, `u32`, `usize` | `int32_t`, `uint32_t` | `i32`, `isize`, `u32`, `usize` | ⌛|
...
| `V128` | ⌛| N/A | `Rational`, `Scientific` | `v128` | `long double` | ⌛| ⌛| ⌛|
